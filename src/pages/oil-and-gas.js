          ...
          <Row>
            <Col xs={12} md={6} lg={6}>
              ...
              <Heading level={2} color="white" size="medium" weight="normal" as="p">
                USVs are already being used in the Oil &amp; Gas industry for projects such as
                seabed and pipeline surveys, environment monitoring and security.
              </Heading>
              <Spacing $value="80px" />
            </Col>
          </Row>
